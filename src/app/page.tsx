  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#services" className="text-gray-700 hover:text-slate-900 font-medium transition-colors">
                Services
              </a>
              <a href="#about" className="text-gray-700 hover:text-slate-900 font-medium transition-colors">
                About
              </a>
              <a href="#testimonials" className="text-gray-700 hover:text-slate-900 font-medium transition-colors">
                Testimonials
              </a>
              <a href="#contact" className="text-gray-700 hover:text-slate-900 font-medium transition-colors">
                Contact
              </a>
              <a
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-4 py-4 space-y-3">
              <a href="#services" className="block text-gray-700 hover:text-slate-900 font-medium py-2">
                Services
              </a>
              <a href="#about" className="block text-gray-700 hover:text-slate-900 font-medium py-2">
                About
              </a>
              <a href="#testimonials" className="block text-gray-700 hover:text-slate-900 font-medium py-2">
                Testimonials
              </a>
              <a href="#contact" className="block text-gray-700 hover:text-slate-900 font-medium py-2">
                Contact
              </a>
              <a
                href="tel:256-606-3109"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
              North Alabama&apos;s
              <span className="text-emerald-400"> Commercial Painting </span>
              Professionals
            </h1>
      ...
      <section className="py-16 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <span className="text-slate-500 font-semibold uppercase tracking-wider">As Seen On</span>
      ...
      <section id="services" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-slate-500 font-semibold uppercase tracking-wider">What We Offer</span>
            <h2 className="font-display text-4xl font-bold text-slate-800 mt-2 mb-4">
            ...
            {services.map((service, index) => (
              <div
                ...
                className={`service-card bg-white rounded-2xl p-8 shadow-lg border ${
                  service.featured ? "border-emerald-600 border-2" : "border-gray-100"
                }`}
              >
                {service.featured && (
                ...
                <div className="text-slate-700 mb-4">{service.icon}</div>
      ...
      <section id="about" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <span className="text-slate-500 font-semibold uppercase tracking-wider">About AmeriPro</span>
              <h2 className="font-display text-4xl font-bold text-slate-800 mt-2 mb-6">
      ...
      <section className="py-16 bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-300">Quality painting services throughout the region</p>
          </div>
      ...
      <section id="testimonials" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-slate-500 font-semibold uppercase tracking-wider">Testimonials</span>
            <h2 className="font-display text-4xl font-bold text-slate-800 mt-2 mb-4">
      ...
      <section id="contact" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <span className="text-slate-500 font-semibold uppercase tracking-wider">Get In Touch</span>
              <h2 className="font-display text-4xl font-bold text-slate-800 mt-2 mb-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:256-606-3109" className="text-gray-600 hover:text-slate-800 text-lg transition-colors">
                      (256) 606-3109
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 shadow-lg">
              <h3 className="font-display text-2xl font-bold text-slate-800 mb-6">
              ...
              <form className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-slate-500 focus:border-transparent transition-all resize-none"
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#services" className="hover:text-slate-300 transition-colors">Commercial Coatings</a></li>
                <li><a href="#services" className="hover:text-slate-300 transition-colors">Industrial Painting</a></li>
                <li><a href="#services" className="hover:text-slate-300 transition-colors">Interior Painting</a></li>
                <li><a href="#services" className="hover:text-slate-300 transition-colors">Exterior Painting</a></li>
                <li><a href="#services" className="hover:text-slate-300 transition-colors">Specialty Coatings</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li>
                  <a href="tel:256-606-3109" className="hover:text-slate-300 transition-colors flex items-center gap-2">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    (256) 606-3109
